                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="{{('public/frontend/checkout.html')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                                <li><a href="{{('public/frontend/cart.html')}}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
                                <li><a href="{{('public/frontend/login.html')}}"><i class="fa fa-lock"></i> Login</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="{{('public/frontend/shop.html')}}">Products</a></li>
                                        <li><a href="{{('public/frontend/product-details.html')}}">Product Details</a></li> 
                                        <li><a href="{{('public/frontend/checkout.html')}}">Checkout</a></li> 
                                        <li><a href="{{('public/frontend/cart.html')}}">Cart</a></li> 
                                        <li><a href="{{('public/frontend/login.html')}}">Login</a></li> 
                                    </ul>
                                </li> 
                                <li class="dropdown"><a href="#">Blog<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="{{('public/frontend/blog.html')}}">Blog List</a></li>
                                        <li><a href="{{('public/frontend/log-single.html')}}">Blog Single</a></li>
                                    </ul>
                                </li> 
                                <li><a href="{{('public/frontend/404.html')}}">404</a></li>
                                <li><a href="{{('public/frontend/contact-us.html')}}">Contact</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-3">
